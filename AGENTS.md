...
## Purpose
Use this repo as the operating system for planned ITS work.
Improve artifacts so work is clear before it starts, visible while in progress, accountable in ownership and decisions, traceable across artifacts and changes, and supportable beyond the original implementer.
...
- Make operating intent, scope boundaries, owners, and decision points explicit.
- Use the lightest control set that still makes the work understandable, controllable, and supportable.

## File Naming
Use lowercase letters with underscores between words for file names.
